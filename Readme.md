...
Robert Koch-Institut (2024): Intensivkapazitäten und COVID-19-Intensivbettenbelegung in Deutschland, Berlin: Zenodo. DOI: [10.5281/zenodo.10513414](http://doi.org/10.5281/zenodo.10513414).  
...
| bundesland_id | Character| `00`: Deutschland, `1` bis `16`: Bundesländer| Identifikationsnummer der Bundesländer basierend auf dem Amtlichen Gemeindeschlüssel (AGS) bzw. ein Wert für das gesamte Bundesgebiet.|
...
| anzahl_meldebereiche| Natürliche Zahl (Integer) | `≥ 0`  | Ein Meldebereich entspricht einer Intensivstation oder einem Intensivbereich, für welchen das dort arbeitende fach-medizinische Personal Meldungen im DIVI-Intensivregister (täglich) abgibt. Die Anzahl der Meldebereiche gibt an, wie viele Meldebereiche der jeweiligen  Aggregationsstufe (Bundesland/Deutschland) gemeldet haben und in den aktuellen Datenstand einfließen. |
...
| intensivbetten_belegt | Natürliche Zahl (Integer) | `≥ 0` oder `NA` | Anzahl der im Meldebereich aktuell belegten sowie zur Belegung am gleichen Tag verplanten Intensivbetten (Low-Care und High-Care) im Rahmen der Akutversorgung, unabhängig von der Behandlungsursache.|
...
| bundesland_name | Character | `Schleswig-Holstein` … `Thueringen` | Name des Bundeslandes. |
